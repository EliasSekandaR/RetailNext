...
export default function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50">
      <div className="bg-[hsl(240,10%,3.9%)] h-screen w-64 border-r border-[hsl(240,3.7%,15.9%)] overflow-y-auto">
        <div className="flex justify-between items-center p-4 border-b border-[hsl(240,3.7%,15.9%)]">
          ...
          <button 
            onClick={onClose}
            className="p-2 rounded-md hover:bg-[hsl(240,3.7%,15.9%)]"
          >
